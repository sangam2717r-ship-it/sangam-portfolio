      ...
      <div>
        ...
        <p className={`text-lg mb-8 ${isDark ? 'text-neutral-400' : 'text-neutral-600'}`}>
         ...
         <div className="flex gap-4">
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/sangam-s-g-a03a35208?" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-full border transition-colors hover:border-indigo-500 hover:text-indigo-500 ${isDark ? 'bg-neutral-900 border-neutral-800 text-neutral-300' : 'bg-neutral-100 border-neutral-300 text-neutral-700'}`}>
            ...
            {/* GitHub */}
            <a href="https://github.com/sangam2717r-ship-it
" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-full border transition-colors hover:border-indigo-500 hover:text-indigo-500 ${isDark ? 'bg-neutral-900 border-neutral-800 text-neutral-300' : 'bg-neutral-100 border-neutral-300 text-neutral-700'}`}>
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/sangamsg?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-full border transition-colors hover:border-indigo-500 hover:text-indigo-500 ${isDark ? 'bg-neutral-900 border-neutral-800 text-neutral-300' : 'bg-neutral-100 border-neutral-300 text-neutral-700'}`}>
